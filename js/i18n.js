...
const DICTIONARIES = {
  en: {
    ...
    quoteList: {
      title: "Quote List",
      subtitle: "Review your selected products before requesting a quotation.",
      empty: "Your Quote List is empty.",
      emptyTitle: "No products added yet",
      emptyDescription:
        "Explore our industrial pump catalog and add products to request a technical quotation.",
  ...
  it: {
    ...
    quoteList: {
      ...
      subtitle: "Rivedi i prodotti selezionati prima di richiedere un preventivo.",
      empty: "La tua lista del preventivo è vuota.",
      emptyTitle: "Nessun prodotto aggiunto",
      emptyDescription:
        "Esplora il nostro catalogo di pompe industriali e aggiungi prodotti per richiedere un preventivo.",
      browseProducts: "Esplora i Prodotti",
      totalProducts: "Totale Prodotti",
      clearList: "Svuota Elenco",
      continueShopping: "Continua la Navigazione",
      remove: "Rimuovi",
  ...
  ar: {
    ...
    quoteList: {
      ...
      subtitle: "راجع المنتجات المحددة قبل تقديم طلب عرض السعر.",
      empty: "قائمة طلب السعر فارغة.",
      emptyTitle: "لم يتم إضافة أي منتجات بعد",
      emptyDescription:
        "تصفح كتالوج المضخات الصناعية وأضف المنتجات لطلب عرض سعر فني.",
